...
import AssignOder from './AssignOder';
...
const Orders = () => {
  ...
  const handleAssignOrder = () => setAssignOrder(true)
              ...
              <tbody>
                <tr className='border-y border-[#E6EDFF]'>
                  ...
                  <th className=' font-Poppins font-[500] text-[12px] text-[#000000] relative '>
                    <span className='flex items-center space-x-2 absolute left-12 top-3 shadow-lg ' onClick={handleAssignOrder}>
                      <span>
                ...
                <tr className='border-y border-[#E6EDFF]'>
                  ...
                  <th className=' font-Poppins font-[500] text-[12px] text-[#000000] '>$847.69</th>
                  <th className=' font-Poppins font-[500] text-[12px] text-[#000000] relative '>
                    <span className='flex items-center space-x-2 absolute left-12 top-3 shadow-lg '>
                      <span>
                        <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="4" cy="4" r="4" fill="#34C759"/>
                        </svg>

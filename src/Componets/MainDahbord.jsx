    ...
    <div className='mx-[30px]'>
      <div className='flex justify-between'>
        <form className='flex items-center mt-[10px] '>
          ...
          <input id='search' type="text" placeholder='Search' className=' w-[30vw] bg-white rounded-[3px]  pl-[50px] py-[10px] px-[50px] text-[#BEC1C9] placeholder:font-Mulish placeholder:font-[400] placeholder:text-[16px] placeholder:leading-[20px] '/>
        </form>
        <div className='flex justify-evenly space-x-2 items-center w-[190px] h-[40px] bg-white mt-[10px]'>
          <div className=' w-[36px] h-[36px] border-2 border-[#FF6600] rounded-full '></div>
